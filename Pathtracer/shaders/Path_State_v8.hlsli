#pragma once
// Addressing of the per-pixel path-state buffer (layout in PathStateLayout.h).
...
// Primary vertex extras the camera pass resolved: IOR pair, medium and absorption at x1.
...
// Training lanes: guide roots and the propagation spill, addressed by lane.
