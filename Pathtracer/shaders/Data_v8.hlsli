...
//PACKED MATERIAL
//====================================================================
//Compressed AoS struct, 40 B per material, was 112 B.
...
//and src/Components/Vertex.h for the CPU packing.
//
//Ke dropped on CPU, emission travels via the LightTriangle buffer.
//
//Offset  Field                     Encoding
//------  ------------------------  --------------------------------
//0       Kd_rgb                    RGB9E5 (32 bit)
//4       w_Ni                      half Kd.w | half Ni
//8       PrPmPsPc                  4x uint8 in [0,1], LSB = Pr
//12      Tf_rgb                    RGB9E5
