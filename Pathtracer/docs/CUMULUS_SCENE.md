...
The medium child billows and whole-body wind distortion remain the density baseline. Conservative empty-sample rejection avoids unnecessary material lookups while preserving the evaluated field and normal stencil. The reference appearance snapshot is `out/cumulus/approved-medium-billows-a0a65824`, with density-header SHA-256 `a0a65824ea78c526b858e40a86363b8ada6ac01fd465d3604d78986bb58b9`. It is an artifact backup, not a Git commit or a recording of live UI settings.
