...
inline float GenPairwiseMIS_canonical_temporal_GI(Reservoir_GI c, Reservoir_GI n, float M_sum, float M_cap){
...
inline float GenPairwiseMIS_noncanonical_temporal_GI(Reservoir_GI c, Reservoir_GI n, float M_sum, float M_cap){
