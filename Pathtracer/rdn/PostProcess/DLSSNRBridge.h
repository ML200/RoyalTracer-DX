...
namespace dlssnr {
// Engine-owned ABI for the optional runtime.
struct Context;
...
DLSSNR_API uint32_t RoyalNRCreateFeature(Context*, ID3D12GraphicsCommandList*, uint32_t width, uint32_t height,
                                         const Tuning*);
