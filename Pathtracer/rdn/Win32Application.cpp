...
int Win32Application::Run(DXSample *pSample, HINSTANCE hInstance,
  ...
  windowClass.lpszClassName = reinterpret_cast<LPCSTR>(L"DXSampleClass");
  ...
  m_hwnd = CreateWindow(windowClass.lpszClassName, reinterpret_cast<LPCSTR>(pSample->GetTitle()),
