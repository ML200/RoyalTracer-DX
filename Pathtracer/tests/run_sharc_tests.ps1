...
foreach ($entry in @('prepare', 'fill', 'resolve', 'query', 'eraseTop', 'benchmark', 'guideFill', 'guideQuery', 'materialCheck', 'materialBenchmark', 'liteCheck', 'materialSamplingCheck', 'liteAccumCheck')) {
    & $dxc -I $ShaderDirectory -T cs_6_6 -E $entry -HV 2021 -enable-16bit-types -O3 -WX `
